...
Generate formatted Excel checklists with color-coded sections, priority levels, input cells, auto-filters, and frozen headers using openpyxl.
...
cp -r productivity/checklist-xlsx ~/.hermes/skills/productivity/checklist-xlsx/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/checklist-xlsx-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/checklist-xlsx-skill.git ~/.hermes/skills/productivity/checklist-xlsx/
```
...
```text
skill_view(name="productivity/checklist-xlsx")
```
...
```text
Use the checklist xlsx skill to <describe your specific task here>
```
...
```text
Gunakan skill checklist xlsx untuk <deskripsikan tugas spesifik Anda di sini>
```
